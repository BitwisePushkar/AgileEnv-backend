...
class User(Base):
    ...
    created_chatrooms = relationship("Chatroom", back_populates="creator")
...
class OTP(Base):
    ...
    max_send_count = Column(Integer, default=5)
    send_locked_until = Column(DateTime(timezone=True), nullable=True)
